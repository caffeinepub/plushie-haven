...
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string | null, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createPost(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPost(arg0: bigint): Promise<Post> {
        if (this.processError) {
            try {
                ...
                return from_candid_Post_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
